        ...
        <div className="main-content">
          <div className="signup-card">
            <div className="form-header">
              <h2>Shelter Staff Registration</h2>
              <p>Register as staff to manage shelter pets and adoption requests.</p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="input-group">
                ...
                <div className="input-with-icon">
                  ...
                  <input
                    type="text"
                    name="staffName"
                    placeholder="e.g. Israt Hossain Snigdha"
              ...
              {/* Staff's Number */}
              <div className="input-group">
                <label>Staff's Personal Number</label>
                <div className="input-with-icon">
                  <Phone className="input-icon" size={18} />
                  <input
                    type="tel"
              ...
              <div className="input-group">
                ...
                <div className="input-with-icon">
                  ...
                  <input
                    type="email"
                    name="email"
                    placeholder="e.g. staff@petconnect.com"
